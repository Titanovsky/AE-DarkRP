...
Ambi.DarkRP.Config.f4menu_show_home = true -- Будет работать страница Основное? [NEW]
Ambi.DarkRP.Config.f4menu_show_jobs = true -- Будет работать страница Работы? [NEW]
Ambi.DarkRP.Config.f4menu_show_shop = true -- Будет работать страница Магазина? [NEW] 
Ambi.DarkRP.Config.f4menu_show_settings = true -- Будет работать страница Настройки? [NEW]
Ambi.DarkRP.Config.f4menu_show_commands = true -- Будет работать страница Команды? [NEW]
