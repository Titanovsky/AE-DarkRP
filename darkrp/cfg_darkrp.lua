Ambi.General.CreateModule( 'DarkRP' )
...
Ambi.DarkRP.Config.money_start = 5000 -- Стартовый запас денег [NEW]
...
Ambi.DarkRP.Config.f4menu_show_restrict_items_and_jobs = false -- Показывать предметы в магазине и работы, которые не подходят игроку? [NEW]
...
Ambi.DarkRP.Config.police_system_wanted_command = 'wanted' -- Команда для Ареста/Освобождения Человека в Розыск! [НУЖЕН РЕСТАРТ] [NEW]
...
Ambi.DarkRP.Config.police_system_wanted_reason = 'Подозрение/Совершение Преступления' -- Стандартная причина подачи в розыск [NEW]
...
Ambi.DarkRP.Config.police_system_warrant_reason = 'Подозрение/Совершение Преступления' -- Стандартная причина [NEW]
...
-- ====================================================================================================================================================== --
-- конфигуратор работает некорректно, пока что не включайте его!
Ambi.DarkRP.configurator_enable = false -- Включить Конфигуратор (Меню с быстрыми изменениями конфига/Добавления контента: Работы, Категорий Дверей и так далее..)