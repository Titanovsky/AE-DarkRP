...
hook.Add( 'PlayerSay', 'Ambi.DarkRP.CompatibilityCommands', function( ePly, sText ) 
    ...
    elseif string.StartWith( sText, '/broadcast' ) and ( Ambi.DarkRP.Config.goverment_license_gun_command != 'broadcast' ) then Send( ePly, Ambi.DarkRP.Config.goverment_license_gun_command )
    ...
    elseif string.StartWith( sText, '/rpname' ) then Send2( ePly )
